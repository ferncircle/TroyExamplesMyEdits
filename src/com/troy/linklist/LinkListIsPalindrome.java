 ...
 * 
 * Solution:
 * 1) Nice use of recursion (Obviously we can use deque or array)
 * 2) Do postorder recursion but pass Head pointer. 
 * 3) While coming backwards in recursion, keep moving head forward
 * 
 * 
 * Test cases:
 * odd number of nodes
