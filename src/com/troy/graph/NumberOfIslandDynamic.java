 ...
 * 
 * Solution:
 * 1) Create disjoint set of cell value
 * 2) After adding each cell(land), check its four neighbors. If there was a land there already(that cell value exists in some 
 * 		set) then merge these two sets and decrease the no. of islands
 */
