 ...
 *
 *Solution:
 *1) This is similar to Dijkstra algorith. But here we start with any random node and continue till heap is empty
 *2) Initialize dist to all nodes to infinity
 *3) Remove min vertex from heap and then update value of its adjacent vertices
 *
 * CLRS book
 */
