 ...
 * 
 * Solution: 1) Write method to return biggest number from array by removing k digits (using stack)
 * 2) Now, goal is to find out biggest number from array1 that has i digits and biggest number from array2 that has
 *  k-i digits
 * 3) Find that i
 * 4) At every i, Merge these two arrays similar to merge step of merge sort to form number of size k and check if it's
 * max so far
 */
public class MaxNumberFromTwoArray {
    ...
    public static void main(String args[]) {
        ...
        int[] result = max.maxNumber(input3, input4, 5);
