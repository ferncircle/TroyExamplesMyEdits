...
1) A box can be placed on top of another box only if both width and depth of the upper placed box are smaller than 
...
there can be three possibilities, {1x2x3}, {2x1x3} 
and {3x1x2}.
