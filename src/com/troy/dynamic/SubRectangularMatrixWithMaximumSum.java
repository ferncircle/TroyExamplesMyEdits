 ...
 * 
 * Solution:
 * 1) Consider two columns (left and right)
 * 2) Create array rowSum[i] = maintains the sum of all elements between these two columns for row i
 * 3) Run Kadane algorithm to find best sum and rowBelow and rowAbove  O(row)
 * 4) Do above steps for all combination of columns O(col^2)
 * 
