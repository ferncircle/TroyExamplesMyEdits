...
Basically you have to find if a given string can be represented from a substring by iterating it times. n >= 2
...
Solution:
1) Notice that we have to find longest prefix that is also a suffix, use KMP
2) Consider string 'abcabcabc', the kmp=[0, 0, 0, 1, 2, 3, 4, 5, 6], it tells to use longest suffix starts at 6
3) Do one more pass, to match suffix(or prefix) to ever interval of same size
...
public class NTMatch {
    ...
    public static void main(String args[]){
        ...
        System.out.println(ntMatch.match("abababab".toCharArray()));
    }
}
