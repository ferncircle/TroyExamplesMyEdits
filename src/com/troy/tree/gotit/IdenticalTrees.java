 ...
 * Given two arrays which represent a sequence of keys. Imagine we make a Binary Search Tree (BST) from 
 * each array. We need to tell whether two BSTs will be identical or not without actually constructing
 *  the tree.
...
Solution:
1) Choose any element, check elements appearing on right and left, they should be same
2) Recurse for left and right elements
