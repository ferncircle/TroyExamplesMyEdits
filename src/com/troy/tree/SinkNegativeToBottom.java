...
import com.troy.tree.gotit.TreeTraversals;

/**
 * http://www.careercup.com/question?id=5344154741637120
 * 
 * Solution:
 * 1) first go bottom (inorder)
 * 2) try to push current node down if it's negative
 * 3) Two separate methods (going down(inorder), pushing down if negative)
 */
