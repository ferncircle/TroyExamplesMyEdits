package com.troy.random;

/**
 * Solution:
 * 1) Create sum array that contain cumulative sum of elements in array.
 * 2) Generate a random number 1 to maxSum
 * 3) Do binary search in sum array to find the 'range' index and return
 *
 */
